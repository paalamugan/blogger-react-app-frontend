...
const bloggerLogo = importer('./assets/blogger-logo.svg');
    ...
    <Drawer anchor="top" open={drawerOpen} onClose={toggleDrawer}>
      ...
      <List component="nav">
        {[
          ...
          {
            title: 'Contact',
            href: 'https://github.com/paalamugan/blogger-react-app-frontend/issues',
            icon: <EmailIcon />,
          },
  ...
  return (
    <div className={classes.root}>
      <AppBar position="fixed" color="secondary" className={classes.appbar}>
        <Toolbar>
          <Avatar alt="Logo" src={bloggerLogo} className={classes.logo} component={Link} to={'/'} />
