...
const AboutUs = () => {
  const bloggerLogo = importer('@ui/header/assets/blogger-logo.svg');
  const blogger1Logo = importer('./assets/blogger1-logo.svg');
  const classes = useStyles();
  return (
...
const LearningResources = () => {
  const classes = useStyles();
  const blog = importer('./assets/blogger-blog.jpg');
  const youtube = importer('./assets/blogger-youtube.jpg');
  const opensource = importer('./assets/blogger1-opensource.jpg');
  const mBlog = importer('./assets/blogger1-blog.jpg');
  const mMedium = importer('./assets/blogger1-medium-blog.jpg');
  const mYoutube = importer('./assets/blogger1-youtube.jpg');
  return (
    <Grid className={classes.resourcesSection} container justify="center" alignItems="center">
      <Grid item xs={11} sm={11} md={11}>
        ...
        <Grid container spacing={4} justify="center" alignItems="stretch">
          ...
          <Grid item xs={12} sm={6} md={4}>
            <ReasourceCard
              href="https://youtube.com/blogger"
              imgUrl={youtube}
              title="Blogger Youtube"
              action="Watch"
              description="Blogger host video lessons and tutorials on computer programming and software development."
            />
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
            <ReasourceCard
              href="https://github.com/paalamugan/blogger-react-app/frontend"
              imgUrl={opensource}
              title="Blogger1 OpenSource"
              action="Explore"
          ...
          <Grid item xs={12} sm={6} md={4}>
            <ReasourceCard
              href="https://blog.blogger1.com"
              imgUrl={mBlog}
              title="Blogger1 Publication"
              action="Read"
              description="Blogs and articles for Android, Kotlin, Machine Learning, React Js, Node Js, iOS and IOT with best development and coding practices"
            />
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
            <ReasourceCard
              href="https://medium.com/blogger1"
              imgUrl={mMedium}
              title="Blogger1 Community Blogs"
              action="Read"
          ...
          <Grid item xs={12} sm={6} md={4}>
            <ReasourceCard
              href="https://youtube.com/blogger1"
              imgUrl={mYoutube}
              title="Blogger1 YouTube"
              action="Watch"
